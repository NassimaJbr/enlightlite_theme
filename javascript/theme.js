...
$(function(){
    ...
    $val = $("#id_s_theme_enlightlite_modified_popularCourse_type").val();
    if ($val == 1) {
    ...
    $("#id_s_theme_enlightlite_modified_popularCourse_type").on('change', function() {
    ...
    var toggelSection = ['#theme_enlightlite_modified_general', '#theme_enlightlite_modified_slideshow', '#theme_enlightlite_modified_marketingspot', '#theme_enlightlite_modified_footer'];
    $.each(toggelSection, function(key, value) {
        ...
        h3.each( function(key) {
            ...
            var toggleHead = '<div class="enlightlite_modified-toggle-head" id="' + childid + '">';
    ...
    $(".enlightlite_modified-toggle-head").click(function(){
        $this = $(this);
    ...
    function toggleicon2(parentid) {
        ...
        parent.find('.enlightlite_modified-toggle-head').each(function() {
            $this = $(this);
