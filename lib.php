...
/**
 * The Library file for theme enlightlite_modified.
 ...
 * @return null
 */
function theme_enlightlite_modified_page_init(moodle_page $page) {
    global $CFG, $SESSION, $PAGE, $OUTPUT;
    $page->requires->jquery();
    $pattern = theme_enlightlite_modified_get_setting('patternselect');
 ...
 * @return string
 */
function theme_enlightlite_modified_process_css($css, $theme) {
    global $OUTPUT, $CFG;
    ...
    $css = theme_enlightlite_modified_custom_css($css , $customcss);
    $css = theme_enlightlite_modified_set_fontwww($css);
    $css = theme_enlightlite_modified_get_pattern_color($css, $theme);
    $css = theme_enlightlite_modified_set_slide_opacity($theme , $css);
    return $css;
}
 ...
 */
function theme_enlightlite_modified_custom_css($css , $customcss) {
    global $CFG;
 ...
 * @return string
 */
function theme_enlightlite_modified_set_bgimg() {
    global $CFG;
    $bgimgs = array('footbgimg' => 'footbgimg.jpg');
    $url = $CFG->wwwroot.'/theme/enlightlite_modified/pix/home/footbgimg.jpg';
    if (file_exists($url)) {
 ...
 * @return string
 */
function theme_enlightlite_modified_set_slide_opacity($theme , $css) {
...
/**
 * Set enlightlite_modified fontww.
 * @param string $css
 * @return string
 */
function theme_enlightlite_modified_set_fontwww($css) {
    global $CFG, $PAGE;
    ...
    $tag = '[[setting:fontwww]]';
    $theme = theme_config::load('enlightlite_modified');
    $css = str_replace($tag, $themewww.'/enlightlite_modified/fonts/', $css);
    return $css;
}
 ...
 * @return string
 */
function theme_enlightlite_modified_pre_css_set_fontwww($css) {
    global $CFG, $PAGE;
    if (empty($CFG->themewww)) {
        $themewww = $CFG->wwwroot."/theme";
    } else {
 ...
 * @return bool
 */
function theme_enlightlite_modified_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    ...
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        ...
        if ($filearea === 'logo') {
            ...
            theme_enlightlite_modified_serve_css($args[1]);
 ...
 * @return string
 */
function theme_enlightlite_modified_serve_css($filename) {
    global $CFG;
    if (!empty($CFG->themedir)) {
        $thestylepath = $CFG->themedir . '/enlightlite_modified/style/';
    } else {
        $thestylepath = $CFG->dirroot . '/theme/enlightlite_modified/style/';
    }
    ...
    if ((($ifmodifiedsince) && (strtotime($ifmodifiedsince) == $lastmodified)) || $etagheader == $etagfile) {
        theme_enlightlite_modified_send_unmodified($lastmodified, $etagfile);
    }
    theme_enlightlite_modified_send_cached_css($thestylepath, $filename, $lastmodified, $etagfile);
}
 ...
 *
 */
function theme_enlightlite_modified_send_unmodified($lastmodified, $etag) {
 ...
 * @param string $etag
 */
function theme_enlightlite_modified_send_cached_css($path, $filename, $lastmodified, $etag) {
    global $CFG;
 ...
 */
function theme_enlightlite_modified_get_html_for_settings(renderer_base $output, moodle_page $page) {
    global $CFG;
    $return = new stdClass;
 ...
 * @return string
 */
function theme_enlightlite_modified_get_logo_url($type='header') {
    global $OUTPUT;
    static $theme;
    if (empty($theme)) {
        $theme = theme_config::load('enlightlite_modified');
 ...
 * @return null
 */
function theme_enlightlite_modified_render_slideimg($p, $sliname) {
    global $PAGE, $OUTPUT;

    $nos = theme_enlightlite_modified_get_setting('numberofslides');
    if (theme_enlightlite_modified_get_setting($sliname)) {
 ...
 * @return bool
 */
function theme_enlightlite_modified_get_setting($setting, $format = true) {
    global $CFG;
 ...
 * @return string
 */
function theme_enlightlite_modified_theme_url() {
    global $CFG, $PAGE;
 ...
 */
function theme_enlightlite_modified_generate_links($menuname = '') {
    global $CFG, $PAGE;
    $htmlstr = '';
    $menustr = theme_enlightlite_modified_get_setting($menuname);
    ...
    foreach ($menusettings as $menukey => $menuval) {
        ...
        if (!empty($expset) && isset($expset[0]) && isset($expset[1])) {
            ...
            $ltxt = trim($ltxt);
            $ltxt = theme_enlightlite_modified_lang($ltxt);
            $lurl = trim($lurl);
            if (empty($ltxt)) {
                continue;
            }
 ...
 */
function theme_enlightlite_modified_social_links() {
    global $CFG;
    $totalicons = 4;
    $htmlstr = '';
    for ($i = 1; $i <= 4; $i++) {
        $iconenable = theme_enlightlite_modified_get_setting('siconenable'.$i);
        $icon = theme_enlightlite_modified_get_setting('socialicon'.$i);
        $iconcolor = theme_enlightlite_modified_get_setting('siconbgc'.$i);
        $iconurl = theme_enlightlite_modified_get_setting('siconurl'.$i);
        $iconstr = '';
 ...
 * @return string
 */
function theme_enlightlite_modified_strip_html_tags( $text ) {
    $text = preg_replace(
        array(
 ...
 * @return string
 */
function theme_enlightlite_modified_course_trim_char($str, $n = 500, $endchar = '&#8230;') {
    if (strlen($str) < $n) {
        return $str;
    }
 ...
 * @return type|string
 */
function theme_enlightlite_modified_marketingspot1() {
    global $CFG, $PAGE;

    $status = theme_enlightlite_modified_get_setting('marketingSpot1_status');
    $description = theme_enlightlite_modified_get_setting('mspot1desc');
    $title = theme_enlightlite_modified_lang(theme_enlightlite_modified_get_setting('mspot1title'));
    $media = theme_enlightlite_modified_get_setting('mspot1media', 'format_html');
    if (!empty($media)) {
    ...
    if (isset($status) && $status == 1 ) {
        $description = theme_enlightlite_modified_lang($description);
 ...
 */
function theme_enlightlite_modified_marketingspot2() {
    $content = '';
    $mspot2status = theme_enlightlite_modified_get_setting('marketingSpot2_status');
    $msp2title = theme_enlightlite_modified_get_setting('mspot2title', 'format_html');
    $msp2title = theme_enlightlite_modified_lang($msp2title);
    $msp2desc = theme_enlightlite_modified_get_setting('mspot2desc', 'format_html');
    $msp2desc = theme_enlightlite_modified_lang($msp2desc);
    $msp2url = theme_enlightlite_modified_get_setting('mspot2url');
    $msp2urltxt = theme_enlightlite_modified_get_setting('mspot2urltext', 'format_html');
    $msp2urltxt = theme_enlightlite_modified_lang($msp2urltxt);
    $mspot2urltarget = theme_enlightlite_modified_get_setting('mspot2urltarget');
 ...
 * @return type|string
 */
function theme_enlightlite_modified_category_menu() {
    global $CFG, $PAGE;
    ...
    foreach ($listing as $listitem) {
        ...
        $html .= theme_enlightlite_modified_category_menu_item(
        $listitem,
        $subcategories,
 ...
 * @return string
 */
function theme_enlightlite_modified_category_menu_item(coursecat $category, array $subcategories, $totalsubcategories,
 ...
 * @return string
 */
function theme_enlightlite_modified_lang($key='') {
    $pos = strpos($key, 'lang:');
    if ($pos !== false) {
        list($l, $k) = explode(":", $key);
        if (get_string_manager()->string_exists($k, 'theme_enlightlite_modified')) {
            $v = get_string($k, 'theme_enlightlite_modified');
            return $v;
        } else {
            return $key;
        }
 ...
 * @return array
 */
function theme_enlightlite_modified_check_our_team_status($nums) {
    foreach ($nums as $key => $value) {
        $con = theme_enlightlite_modified_get_team_user($value, 'check');
        if ($con == "") {
            unset($nums[$key]);
        }
    }
 ...
 * @return string
 */
function enlightlite_modified_check_length($value, $length) {
 ...
 * @return bool
 */
function theme_enlightlite_modified_combolist_type() {
    global $PAGE;
    $type = theme_enlightlite_modified_get_setting('comboListboxType');
    if ($type == 1) {
        return true;
    } else {
        return false;
 ...
 * @return string
 */
function theme_enlightlite_modified_footer_address($check = "") {
    global $PAGE;
    $value = '';
    $address = theme_enlightlite_modified_get_setting('footaddress');
    $address = theme_enlightlite_modified_lang($address);
    $email = theme_enlightlite_modified_get_setting('footemailid');
    $email = theme_enlightlite_modified_lang($email);
    $phone = theme_enlightlite_modified_get_setting('footphoneno');
    $phone = theme_enlightlite_modified_lang($phone);
    if (!empty($address) || !empty($email) || !empty($phone)) {
        ...
        if (!empty($email)) {
            ...
            $value .= "<i class='fa fa-envelope'></i>".get_string('emailid', 'theme_enlightlite_modified').": ";
 ...
 * @return string
 */
function theme_enlightlite_modified_get_pattern_color( $css, $type='') {
    global $CFG;
    $patterncolors = include($CFG->dirroot.'/theme/enlightlite_modified/classes/pattern_colors.php');
    $selectedpattern = theme_enlightlite_modified_get_setting('patternselect');
 ...
 * @return string
 */
function theme_enlightlite_modified_get_hexa($hexa, $opacity) {
    if (!empty($hexa)) {
