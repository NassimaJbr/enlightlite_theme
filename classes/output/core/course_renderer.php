...
/**
 * Theme enlightlite_modified course renderer class inherit from core course renderer class.
 * @copyright  2015 onwards LMSACE Dev Team (http://www.lmsace.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_renderer extends \core_course_renderer {
    ...
    public function frontpage_categories_list() {
        ...
        foreach ($categories as $key => $value) {
            $content .= $this->enlightlite_modified_coursecat_category($chelper, core_course_category::get($key), 1);
        }
     ...
     * @return string
     */
    public function enlightlite_modified_coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
    ...
    public function course_search_form($value = '', $format = 'plain') {
        ...
        if ($this->page->pagelayout == "frontpage") {
            $output .= html_writer::tag('h2', get_string('search_courses', 'theme_enlightlite_modified'));
        }
        ...
        $output .= html_writer::empty_tag('input',
            array('type' => 'text',
                ...
                'size' => $inputsize,
                'name' => 'search',
                'placeholder' => get_string('typesearch', 'theme_enlightlite_modified'),
                'value' => s($value)));
...
} // Here the theme_enlightlite_modified_course renderer fucntion closed.
