...
namespace theme_enlightlite_modified\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    protected function custom_menu_render(\custom_menu $menu) {
        ...
        $cmenushow = theme_enlightlite_modified_get_setting('cmenushow');
        ...
        foreach ($menu->get_children() as $key => $item) {
            ...
            $skey = $key + 1;
            $coursemenu = $this->enlightlite_modified_course_menu_position($skey, $count);
     ...
     * @return null
     */
    public function enlightlite_modified_course_menu_position($skey, $count) {
        global $CFG;
        $status = "";
        $cmenuposition = $this->page->theme->settings->cmenuPosition;
    ...
    public function top_course_menu() {
        ...
        if (!empty($rcourseids)) {
            ...
            '.get_string('viewall', 'theme_enlightlite_modified').'</a></li></ul>';
        }
